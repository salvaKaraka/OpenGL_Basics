...
int main()
{
    ...
    // Window creation
    GLFWwindow* window = glfwCreateWindow(width, height, "OpenGL_First_Project", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    unsigned int VBO, cubeVAO, lightCubeVAO; // Buffers
    glGenBuffers(1, &VBO);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //setting lighting shadder uniforms
        lightingShader.use();
